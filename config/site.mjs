...
export const hostedOrigin = 'https://udhawan97.github.io';
export const hostedProjectUrl = `${hostedOrigin}${projectBasePath}/`;
export const hostedAppUrl = `${hostedOrigin}${appBasePath}/`;
