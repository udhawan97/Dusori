...
The v0.12.2 macOS and Windows installers are not Apple-notarized or Microsoft code-signed. Users should download them only from the official GitHub release and verify `SHA256SUMS.txt`. The in-app updater signature is a separate trust mechanism and does not suppress Gatekeeper or SmartScreen warnings.
