...
<p align="center">
  <a href="https://udhawan97.github.io/Dusori/app/"><strong>Open in browser</strong></a> ·
  <a href="https://github.com/udhawan97/Dusori/releases/tag/v0.12.0"><strong>Download v0.12.0</strong></a> ·
...
| **macOS — Apple silicon** | M-series Macs; bundled app and signed in-app updater feed            | **[Open v0.12.0 downloads](https://github.com/udhawan97/Dusori/releases/tag/v0.12.0)** |
| **macOS — Intel**         | Intel Macs; bundled app and signed in-app updater feed               | **[Open v0.12.0 downloads](https://github.com/udhawan97/Dusori/releases/tag/v0.12.0)** |
| **Windows — x64**         | 64-bit Windows; bundled app and signed in-app updater feed           | **[Open v0.12.0 downloads](https://github.com/udhawan97/Dusori/releases/tag/v0.12.0)** |
