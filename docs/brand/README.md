...
- `docs/assets/dusori-readme-logo-inverted.svg` — reversed monochrome README lockup on black
...
- Product icons, compact marks, and the README lockup stay static.
...
The core mark is static by design. Motion belongs to product interactions, not the identity itself.
