...
Run the published companion with `npx @udhawan97/dusori@0.4.0 --root /path/to/Dusori`, or build it from a clone as described in [Getting started](../getting-started/). Omit `--root` to keep folder access off.
