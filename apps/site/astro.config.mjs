      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'v0.12.0 release', slug: 'docs/releases/v0-12-0' },
            { label: 'v0.11.3 release', slug: 'docs/releases/v0-11-3' },
            { label: 'v0.11.2 release', slug: 'docs/releases/v0-11-2' },
            { label: 'v0.11.1 release', slug: 'docs/releases/v0-11-1' },
            { label: 'v0.11.0 release', slug: 'docs/releases/v0-11-0' },
            { label: 'v0.10.0 release', slug: 'docs/releases/v0-10-0' },
            { label: 'v0.9.1 release', slug: 'docs/releases/v0-9-1' },
            { label: 'v0.9.0 release', slug: 'docs/releases/v0-9-0' },
            { label: 'v0.8.1 release', slug: 'docs/releases/v0-8-1' },
            { label: 'v0.8.0 release', slug: 'docs/releases/v0-8-0' },
            { label: 'v0.7.1 release', slug: 'docs/releases/v0-7-1' },
            { label: 'v0.7.0 release', slug: 'docs/releases/v0-7-0' },
            { label: 'v0.6.0 release', slug: 'docs/releases/v0-6-0' },
